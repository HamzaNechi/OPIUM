        ...
        <nav class="accent-menu main-navigation p-absolute  w-100  d-flex align-items-baseline ">
            ...
            <ul class="extend-container p-relative d-flex flex-column justify-content-center h-100">
                ...
                <li class="dsn-active dsn-drop-down">
                    <a href="{{ url('/opium')}}" class="user-no-selection">
                ...
                <li>
                    <a href="{{ url('/menu')}}" class="user-no-selection">
                ...
                <li class="dsn-drop-down">
                    <a href="{{ url('/event_vitrine')}}" class="user-no-selection">

                        <span class="dsn-title-menu">ÉVÉNEMENT</span>
                ...
                <li class="dsn-drop-down">
                    <a href="{{ url('/reservation_vitrine/NULL')}}" class="user-no-selection">
