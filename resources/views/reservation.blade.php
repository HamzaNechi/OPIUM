...
<div class="page-header">
              <h3 class="page-title">
                <a href="{{ url('/Réservations/reservation_en_pdf')}}" title="Télécharger pdf">
...
<div class="row">
  ...
  <div class="col-lg-4">
    <form method="get" action="{{ url('/Rechercher/Réservation')}}">
  ...
  <div class="col-lg-4">
    ...
    @endif
      ...
      <form method="get" action="{{ url('/Trier_reservation_par_date') }}">
        <div class="form-group">
          <div class="input-group">
            <input type="date" class="form-control form-control-sm" aria-label="Recipient's username" aria-describedby="basic-addon2" name="recherche">
            <div class="input-group-append">
              <button class="btn btn-sm btn-gradient-primary" type="submit"><i class="mdi mdi-magnify"></i></button>
            </div>
          </div>
      ...
      <div class="modal-body">
        <form method="get" action="{{ url('/Supprimer/Réservation') }}">
          <div class="form-group">
            ...
            <input type="hidden" class="form-control" id="id_book" name="id_book" value="">
          </div>
